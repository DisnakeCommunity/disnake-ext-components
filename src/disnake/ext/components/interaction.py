...
@typing.overload
def wrap_interaction(interaction: disnake.ApplicationCommandInteraction) -> WrappedInteraction:
    ...
...
def wrap_interaction(interaction: disnake.Interaction) -> WrappedInteraction | MessageInteraction:
