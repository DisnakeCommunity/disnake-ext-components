...
class InviteParser(base.Parser, is_default_for=(disnake.Invite,)):
    def __init__(self, *, with_counts: bool = True, with_expiration: bool = True, guild_scheduled_event_id: typing.Optional[int] = None) -> None:
    ...
    async def loads(self, inter: disnake.Interaction, argument: str) -> disnake.Invite:
        return await inter.bot.fetch_invite(argument, with_counts=self.with_counts, with_expiration=self.with_expiration, guild_scheduled_event_id=self.guild_scheduled_event_id)
